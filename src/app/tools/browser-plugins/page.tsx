...
export default function BrowserPluginsPage() {
  ...
  if (!data) return <ToolLoading title="Browser Plugins & PDF Support" />;
  const schema = {
        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Modern browsers expose a reduced, standardized Navigator.plugins list, often centered on built-in PDF handling rather than a complete inventory. Returned values can still contribute one signal to browser classification."
            }
          },
          {
            "@type": "Question",
  ...
  return (
    <div className={styles.toolPage}>
      <div className="container">
        ...
        />
      <div className={styles.header}><span className={styles.icon}>🧩</span><h1 className={styles.title}>Browser Plugins & PDF Support</h1><p className={styles.subtitle}>Inspect the browser&apos;s reduced plugins surface, MIME types, and PDF viewer support. This cannot list extensions.</p></div>
