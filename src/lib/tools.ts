...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    metaDescription: "Test for WebRTC IP leaks that can expose your real IP address even when using a VPN. Free WebRTC leak test with detailed results and fix instructions.",
    icon: "🔓",
    category: "privacy",
  ...
  },
  {
    ...
    metaDescription: "See your unique canvas fingerprint that websites use to track you. Learn how canvas fingerprinting works and how to protect your privacy. Free test.",
    icon: "🎨",
    category: "privacy",
  ...
  },
  {
    ...
    metaDescription: "Detect which fonts are installed on your system through your browser. See how font detection contributes to browser fingerprinting. Free font test.",
    icon: "🔤",
    category: "privacy",
  ...
  },
  {
    ...
    metaDescription: "Test your audio fingerprint generated by the AudioContext API. See how websites use audio processing to uniquely identify your device. Free test.",
    icon: "🔊",
    category: "privacy",
  ...
  },
  {
    ...
    metaDescription: "Check what browser plugins and MIME types are detectable by websites. See PDF viewer support and plugin-based fingerprinting. Free online tool.",
    icon: "🧩",
    category: "features",
...
export const categories = {
  identity: { name: "Identity & Info", color: "#00d4ff" },
  privacy: { name: "Privacy & Fingerprinting", color: "#f43f5e" },
  hardware: { name: "Hardware & Network", color: "#10b981" },
  features: { name: "Features & Support", color: "#f59e0b" },
};
